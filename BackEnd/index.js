...
const getInventoryRoute = require('./controller/getInventory')
const changeStatusRoute = require('./controller/changeStatus')
...
app.get("/getInventory", getInventoryRoute)
app.put("/changeStatus", changeStatusRoute)
